...
/**
 * Convert string into a web-safe URL
 *
 * @param string $string
 * @return string
 */
...
{
	// Convert all alphabetic characters to lowercase and convert string to UTF-8 character encoding
	 $url = mb_strtolower(trim($string), 'utf-8');
	...
	// Replace the Cyrillic alphabet characters
